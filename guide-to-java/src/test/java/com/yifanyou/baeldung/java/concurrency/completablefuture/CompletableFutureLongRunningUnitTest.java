package com.yifanyou.baeldung.java.concurrency.completablefuture;
...
public class CompletableFutureLongRunningUnitTest {
    ...
    //在complete前后加入LOG日志打印；如果只在complete加LOG日志打印，控制台会看不到。因为主线程在打印之前已经执行结束
